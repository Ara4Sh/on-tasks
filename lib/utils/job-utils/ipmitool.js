    ...
    */
    Ipmitool.prototype.runCommand = function(host, user, password, command) {
        return new Promise(function (resolve, reject) {
                var options = { timeout: 60000, maxBuffer:1600*1024 };
    ...
    /**
     * Returns a promise with the results of the user ipmitool command
     *
     * @param host
     * @param user
     * @param password
     * @param command
     */
    Ipmitool.prototype.genericCommand = function(host, user, password, command) {
     ...
     * @param password
     */
    Ipmitool.prototype.setBootPxeEFI = function(host, user, password) {
        return this.runCommand(host, user, password, "chassis bootdev pxe options=efiboot");
    };
